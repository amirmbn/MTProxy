...
قبل از اجرا کد زیر به بات @MTProxybot در تلگرام مراجعه کنید و یک پروکسی جدید بسازید و آی پی سرور و پورت 6900 اگر تغییر ندادید و سکرت کد fe7034e21304d30a82f634358a5ab18f را به ربات بدهید و در نهایت تگی که بات به شما میدهد را ذخیره کنید تا در ادامه از آن استفاده کنید<br>
پروکسی ساخته شده را انتخاب و Edit promotion را بزنید، آیدی کانال تلگرامی که میخواهید تبلیغ کنید را وارد کنید<br>
کد زیر را برای متوقف کردن کانتینر mtproto-proxy وارد کنید
</div>
<div align="left">
...
کانتینر mtproto-proxy را پاک کنید تا تگ کانال تبلیغاتی را اضافه کنید
</div>
<div align="left">
