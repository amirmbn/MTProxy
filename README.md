...
قبل از اجرا کد زیر به بات @MTProxybot در تلگرام مراجعه کنید و یک پروکسی جدید بسازید.<br>
آی پی سرور:6900<br>
سکرت کد: fe7034e21304d30a82f634358a5ab18f<br>
را به بات بدهید و در نهایت تگی که بات به شما میدهد را ذخیره کنید تا در ادامه از آن استفاده کنید<br>
